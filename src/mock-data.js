...
export const mockFixture = Object.freeze({
  meeting: {
    ...
    statusHistory: [
      ...
      ['in_waiting_room', 'bot.in_waiting_room', '2026-01-15T17:00:12.000Z'],
      ['recording', 'bot.in_call_recording', '2026-01-15T17:00:30.000Z'],
      ['processing', 'bot.call_ended', '2026-01-15T17:31:00.000Z'],
      ['complete', 'bot.done', '2026-01-15T17:31:08.000Z'],
    ].map(([status, eventType, occurredAt]) => ({ status, eventType, code: status, subCode: null, occurredAt })),
